        ...
        <div class="container">
            ...
            <section class="featured-properties-area section-padding-100-50">
                ...
                <div class="section-heading wow fadeInUp">
                    <h2 style="font-family: 'Sarabun', sans-serif;">VIP elanlar</h2>
                    <p></p>
                </div>
                                  ...
                                  @if(isset($vipitem->region))
                                    ...
                                    <div  class="property-meta-data  align-items-end justify-content-between">
                                      ...
                                      @if(isset($vipitem->floor_count))
                                        <!-- <div class="new-tag">
                                          <span style="color:#7d7d7d"><b> Mertebe say? : <span style="color:#947054">{{$vipitem->floor_count}}</b></span></span>
                                        </div> -->
                                        ...
                                        <!-- <div class="bathroom">
                                            <span style="color:#7d7d7d"><b> Otaq say? : <span style="color:#947054">{{$vipitem->room_count}}</b></span></span>
                                        </div> -->
                        ...
                        @if(isset($item->region))
                          ...
                          <div  class="property-meta-data  align-items-end justify-content-between">
                            ...
                            @if(isset($item->floor_count))
                              <!-- <div class="new-tag">
                                <span style="color:#7d7d7d"><b> Mertebe say? : <span style="color:#947054">{{$item->floor_count}}</b></span></span>
                              </div> -->
                              ...
                              <!-- <div class="bathroom">
                                  <span style="color:#7d7d7d"><b> Otaq say? : <span style="color:#947054">{{$item->room_count}}</b></span></span>
                              </div> -->
